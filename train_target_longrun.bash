...
#python Train_target.py --dataset visdac/target --source visdac_source --batch_size 64 --num_class 12 --lr 0.01 --run_name visdac_source2target_adacontrast_plot_error_pairs --num_epochs 60 --num_neighbors 100 --temporal_length 1 --neg_l --reweighting --wandb
